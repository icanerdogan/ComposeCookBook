...
class PagerState(
    ...
    private var _minPage by mutableIntStateOf(minPage)
    var minPage: Int
        get() = _minPage
        set(value) {
    ...
    private var _maxPage by mutableIntStateOf(maxPage)
    var maxPage: Int
        get() = _maxPage
        set(value) {
    ...
    private var _currentPage by mutableIntStateOf(currentPage.coerceIn(minPage, maxPage))
    var currentPage: Int
        get() = _currentPage
        set(value) {
